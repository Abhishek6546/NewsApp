  ...
  return (
    <div className="p-6 sm:p-8 max-w-md sm:max-w-lg mx-auto bg-gradient-to-r from-gray-50 to-white rounded-xl shadow-xl mt-20 ">
      <h2 className="text-2xl sm:text-3xl font-extrabold text-center text-gray-800 mb-6 sm:mb-8">
        {login ? "Welcome Back!" : "Login to Your Account"}
      </h2>
      <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-6">
        ...
        {login && (
          <button
            ...
            className="w-full bg-red-500 text-white font-semibold py-2 sm:py-3 rounded-lg hover:opacity-90 focus:outline-none focus:ring-4 focus:ring-red-300 transition"
          >
            Logout
          </button>
        )}
